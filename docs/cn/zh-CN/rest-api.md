...
```json
{
  "result": {
    ...
    "full_content_file_url": "https://oss.qveris.cn/tool_result_cache%2F20260120%2Fpubmed_refined.search_articles.v1%2F2409f329c07949a295b5ab0b704883ca.json?OSSAccessKeyId=YOUR_ACCESS_KEY_ID&Expires=1768920673&Signature=YOUR_SIGNATURE",
  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        tool_id: {
          type: 'string',
          description: '要调用的远程工具 ID（来自搜索结果）',
        },
        search_id: {
          type: 'string',
